...
<body>
    ...
    <ul class="nav navbar-nav navbar-right">
      <li><a href="{{ url('signup') }}" class="borderNavbarRight" style="margin-right: 10px; background-color: #016170; font-weight: bold; color: white; border: none;"> Sign Up</a></li>
      <li><a href="{{ url('/') }}" class="borderNavbarRight" style="background-color: #016170; font-weight: bold; color: white;border: none;"> Login </a></li>
    </ul>
    </div>
    </div>
    </nav>
